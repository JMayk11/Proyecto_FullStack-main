...
## Matriz Completa de Microservicios e Infraestructura
...
## Enrutamiento Perimetral en API Gateway (Puerto: 8080)
...
* **Productos UI:** `http://localhost:8081/swagger-ui/index.html`
...
* **Soporte UI:** `http://localhost:8086/swagger-ui/index.html`
